      ...
      <aside className='fixed left-0 flex flex-row shrink-0 z-50 items-center justify-center' >
        ...
        >
          ...
          <ul className='h-screen w-full'>
            ...
            >
              {open == true ? (<FontAwesomeIcon icon={faHouse} className="mr-2 text-lg" />)
                : (<FontAwesomeIcon icon={faHouse} className="iconCircle" />)
              }
              {open && <li className="text-lg list-none">Dashboard</li>}
            </Link>
            <Link to="/dashboard/governance"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faGavel} className='mr-2 text-lg' />)
                : (<FontAwesomeIcon icon={faGavel} className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Governance</li>}
            </Link>
            <Link to="/dashboard/risks"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faChartSimple} className='mr-2 text-lg' />
              )
                : (<FontAwesomeIcon icon={faChartSimple}
                  className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Risks</li>}
            </Link>
            <Link to="/dashboard/compliance"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faShield} className='mr-2 text-lg' />

              )
                : (<FontAwesomeIcon icon={faShield}
                  className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Compliance</li>}
            </Link>
            <Link to="/dashboard/incidents"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faTriangleExclamation} className='mr-2 text-lg' />

              )
                : (<FontAwesomeIcon icon={faTriangleExclamation}
                  className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Incidents</li>}
            </Link>
            <Link to="/dashboard/threats"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faCircleExclamation} className='mr-2 text-lg' />
              )
                : (<FontAwesomeIcon icon={faCircleExclamation}
                  className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Threats</li>}
            </Link>
            <Link to="/dashboard/logs"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faFileLines} className='mr-2 text-lg' />
              )
                : (<FontAwesomeIcon icon={faFileLines}
                  className="iconCircle" />)
              }
              {open && <li className='text-lg list-none'>Logs</li>}
            </Link>
            <Link to="/dashboard/configurations"
              ...
              className={!open == true ? "closeLink" : "link"}
            >
              {open == true ? (<FontAwesomeIcon icon={faGear} className='mr-2 text-lg' />
              )
                : (<FontAwesomeIcon icon={faGear}
                  className="iconCircle" />)
              }
              {open && <li className=' text-lg list-none'>Configurations</li>}
            </Link>
          </ul>
          ...
          <footer className={open == true ? 'h-46 w-full flex items-center' : "h-46  flex items-center"}>
            <Link to="/"
              ...
              title='Logout'
            >
              {open == true ? (<FontAwesomeIcon icon={faRightFromBracket} className=' mr-2 text-lg' />)
                : (<FontAwesomeIcon icon={faRightFromBracket}
                  className="iconCircle" />)
              }
              {open && <li className=' text-lg list-none'>Logout</li>}
            </Link>
          </footer>
        </div>
      </aside>
